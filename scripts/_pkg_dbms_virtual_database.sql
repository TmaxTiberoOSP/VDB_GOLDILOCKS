...
IS
    ...
    PROCEDURE "GET_TURBO_CONNECTION_INFO"(
        VDB_IP OUT VARCHAR2,
        VDB_PORT OUT VARCHAR2,
        ID OUT VARCHAR2,
        PASSWORD OUT VARCHAR2)
    PRAGMA BUILTIN('pkg_dbms_virtual_database__get_turbo_connection_info');

    FUNCTION "EXECUTE_TURBO_DDL_JEPA"(
        DDL IN VARCHAR2,
        VDB_IP IN VARCHAR2,
        VDB_PORT IN VARCHAR2,
        REMOTE_ID IN VARCHAR2,
    ...
    LANGUAGE JAVA NAME 'ExecuteTurboJDBC.ExecuteTurbo(String, String, String, String, String) return String';

    PROCEDURE "EXECUTE_TURBO_DDL"(DDL IN VARCHAR2)
    IS
        VDB_IP          VARCHAR2(20);
        VDB_PORT        VARCHAR2(20);
        ID              VARCHAR(100);
    ...
    BEGIN
        ...
        GET_TURBO_CONNECTION_INFO(VDB_IP, VDB_PORT, ID, PASSWD);
        ERR_MSG := EXECUTE_TURBO_DDL_JEPA(DDL, VDB_IP, VDB_PORT, ID, PASSWD);
